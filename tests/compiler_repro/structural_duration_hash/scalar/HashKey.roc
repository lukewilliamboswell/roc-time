...
duration_key = |duration| match duration {
	...
	Calendar(value) => Calendar({ components: Calendar.Delta.to_components(value.delta), invalid_date: value.invalid_date, tail: PosixDelta.to_microseconds(value.tail) })
}
