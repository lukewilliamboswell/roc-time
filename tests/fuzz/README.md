...
| `recurrence-v1` | R11–R12: 2024–2025 monthly schedules on day 31 or the last Monday, intervals 1–3, COUNT 1–6, duplicate inclusions, exclusions and query starts in every month. An independent month-table/weekday walk builds the finite set before query filtering. Resumptions with 1–128 work steps and one output slot must yield exactly that set. Fixed tests add UNTIL, positive positions, zero/reduced buffer limits and provider endpoints. |
