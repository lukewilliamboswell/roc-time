...
The test roots `tests/precision/main.roc`, `tests/spans/main.roc`, `tests/coverage/main.roc`, and `tests/gregorian/main.roc`
...
`SpanCase`, `CoverageCase`, or `GregorianCase`). Generators and semantic checks live in those
