...
| `zones-v1` | R07: two synthetic transitions, offsets -2 through 2 seconds, local labels within a complete finite rule domain and arbitrary microsecond fractions; classification compared with independent timeline-cell enumeration. Fixed fixtures add three-occurrence folds and incomplete-domain errors. |
