		...
		Ok(
			Str.join_with(
				[
					...
					"<div class=\"layout\"><aside><p class=\"eyebrow\">Documentation</p><nav aria-label=\"Documentation\">${nav}</nav><p class=\"release\">Run a compatible example<br><a href=\"versions.html\">Compiler & package versions →</a></p></aside>",
					"<main id=\"content\"><p class=\"eyebrow\">roc-time / ${current.label}</p><article>${body}</article><footer>Built with <a href=\"https://github.com/lukewilliamboswell/basic-ssg\">basic-ssg</a> and Roc. <a href=\"https://github.com/lukewilliamboswell/roc-time/tree/main/www/content\">Improve these guides</a>.</footer></main></div></body></html>",
				],
				"",
			),
		)
