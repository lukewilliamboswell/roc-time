...
- Extend hosted resource gates beyond scalar comparison and zone lookup: huge recurrence horizons with tiny prefixes and sparse work-limited searches; coordinate-extent-independent span operations; member-count scaling for coverage and events; bounded zone selection and inspection. Separate construction from consumption, include early-stop/resume and failing controls in dev/speed builds, and instrument live/peak requested bytes before making retained-memory claims.
