...
def generate(wheel):
    ...
    manifest = dict(version=1, profile="zones-tzdata-2025b-v1", case_count=len(cases),
    ...
    print(f"Generated {len(cases)} zone cases; checked every second of three 10-day rule fixtures")
