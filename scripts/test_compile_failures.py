...
def main() -> None:
    ...
    cases = {
        "cursor_as_schedule_definition": ["first argument", "TimedSchedule", "ScheduleDefinition"],
        ...
        "description_as_display": ["first argument", "Calendar.Value", "GregorianDate"],
        ...
        "timestamp_as_selection": ["first argument", "OffsetTimestamp", "Calendar.Value"],
        ...
        "posix_as_calendar_delta": ["second argument", "PosixDelta", "Calendar.Delta"],
