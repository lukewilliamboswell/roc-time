...
def check_output(example: Path, actual: str, *, expected_dir: Path | None = None,
    ...
    if example.parent.name in {"invoice_terms", "overnight_staffing", "upcoming_meetings", "booking_exchange", "archive_search", "staffing", "appointment_display", "zoned_appointment", "clock_deadline_checks", "invoice_report", "invoice_report_checks", "schedule_exchange", "meeting_exchange", "schedule_definition_checks", "utc_cancellations_checks"} and not expected.is_file():
